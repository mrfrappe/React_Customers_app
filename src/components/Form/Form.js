...
const Form = ({object, type, mode, ...props}) => {
            ...
            {(context) => (
                type === 'customers' ? (                  
                    <>
                        {mode === 'add' ?
                            (
                            <div className={styles.wrapper_customers}>
                            ...
                            (
                                <div className={styles.wrapper_customers__edit}>
                ...
                (
                    <>
                         {mode === 'add' ?
                            (
                                <div className={styles.wrapper_invoices}>
                                    <Title title="Add new invoice"/>
                                    <form className={styles.form} onSubmit={(e) => context.onAddInvoice(e, props.id)}>
                                        {props.view ? (
<>
                                        <Input 
                                        name="net"
                                        ...
                                        <Input 
                                            ...
                                            text="Payed"
                                        />
                                        <Button tag="button" onClick={context.onModalInvoiceToggle}>Cancel</Button>
                                        <Button tag="button" secondary="true">New invoice</Button>
                                        </>
                                    )
                                        :
                                        (
